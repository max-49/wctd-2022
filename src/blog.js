            ...
            <table style={{marginLeft:"auto", marginRight:"auto", textAlign:"center"}}>
                ...
                <tr>
                    <div style= {{borderStyle:"double", borderWidth:"8px", backgroundColor:"#eccfe2", textAlign:"center", padding:"10px"}}>
                        <img src="https://static01.nyt.com/images/2012/12/04/nyregion/Y-HOSPITALS1/Y-HOSPITALS1-superJumbo.jpg" style={{width: "100%"}}></img>
                        <h3>1/28/2022</h3>
                    ...
                    <br/>
                    <div style= {{borderStyle:"double", borderWidth:"8px", backgroundColor:"#eccfe2", textAlign:"center", padding:"10px"}}>
                        <img src="https://www.verdict.co.uk/wp-content/uploads/2019/06/shutterstock_744393142.jpg" style={{width: "100%"}}></img>
                        <h3>1/29/2022</h3>
